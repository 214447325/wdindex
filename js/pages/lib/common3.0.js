  ...
  !function(){
    ...
    if($nav.length > 0){
      ...
      var _tpl = [
        ...
        '<a href="javascript:;" data-href="'+ Setting.staticRoot +'/pages/financing/current.html" class="money{{?it == "money"}} active{{?}}">理财</a>',
        '<a href="javascript:;" data-href="'+ Setting.staticRoot +'/pages/message/messages.html" class="explore{{?it == "explore"}} active{{?}}">社区</a>',
