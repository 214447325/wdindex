...
$(function(){
  ...
  !function(){
    ...
    if($nav.length > 0){
      ...
      var _tpl = [
        ...
        '<a href="javascript:;" data-href="'+ Setting.staticRoot +'/pages/financing/float.html" class="money{{?it == "money"}} active{{?}}">理财</a>',
        '<a href="javascript:;" data-login="true" data-href="'+ Setting.staticRoot +'/pages/my-account/my-account.html" class="account{{?it == "account"}} active{{?}}">账户</a>'
      ].join('');
  ...
  $.extend(Common, {
    ...
    weixinLogin : function (weixin){
      ...
      queryChannel:function(param,channel) {
          var datas = {};
          datas.channel = channel;
          datas.types = 1;
          datas.utm_source = param.utm_source;
          datas.utm_medium = param.utm_medium;
          datas.utm_content = param.utm_content;
          datas.utm_campaign = param.utm_campaign;
          datas.utm_term = param.utm_term;
          datas.utm_name = param.utm_name;
          if(param.utm_reserve2 != undefined) {
              datas.utm_reserve2 = param.utm_reserve2
          }
          if(param.utm_reserve3 != undefined) {
              datas.utm_reserve3 = param.utm_reserve3
          }
          if(param.utm_reserve4 != undefined) {
              datas.utm_reserve4 = param.utm_reserve4
          }
          $.ajax({
              url:Setting.apiRoot1 + '/queryChannel.p2p',
              type:'post',
              data:datas,
              async: false
          }).done(function(res) {
      ...
      saveChannel: function(channelId,cId,userId) {
          var datas = {};
          $.ajax({
              url:Setting.apiRoot1 + '/saveChannel.p2p',
              type:'post',
              data:{
                  channel_id:channelId,
                  channel_param_id:cId,
                  user_id:userId
              },
              async: false
          }).done(function(res) {
