    ...
    var noiveBody = new Vue({
        ...
        methods : {
            ...
            init : function(){
                ...
                if(noiveBody.channerlId != 0 && param != undefined && param.utm_source != null && param.utm_source != '') {
                    var datas = Common.queryChannel(param,noiveBody.channerlId);
                    noiveBody.codeFirst = datas.code;
                   if(datas.code != 1) {
                       alert(datas.message);
                       return false;
                   } else {
                       noiveBody.cId = datas.data.id;
                   }
                }
            },
            //点击立即注册
            ...
            userRegister : function() {
                ...
                if(this.check1(phone,imgCode)) {
                    if(this.check2(password,code)) {
                        ...
                        formData.channelId = noiveBody.channerlId;
                                    ...
                                    if(res.code == 1) {
                                        ...
                                        $.ajax({
                                            ...
                                            if(res.code == 1) {
                                                ...
                                                if(noiveBody.codeFirst == 1) {
                                                    var datas = Common.saveChannel(noiveBody.channerlId,noiveBody.cId,sessionStorage.getItem('uid'));
                                                    if(datas.code == 1) {
                                                        alert('注册成功！');
