...
$(function(){
    ...
    var appDowlond = '<div class="msk">' +
                    '<div class="alert-login-content">' +
                    '<div class="alertbox">' +
                    '<div class="mskClose">x</div>'+
                    '<img src="../images/pages/vDowlond.png" alt="" />'+
                    '<div class="top-up-button">' +
                        '<div>扫码下载'+
                        '<span>V金融app</span>'+
                        '，前往'+
                        '<span>“账户-超值礼券”</span></br>'+
                        '中查看新手礼包，开启投资之旅吧！</div>'+
                    '</div>' +
                    '</div>' +
                    '</div>' +
                    '</div>';
    $body.after(appDowlond);
